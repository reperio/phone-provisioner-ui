...
export async function getManufacturers(organization: string) {
    const manufacturers = await axios.get(`${API_URL}/config/${organization}/manufacturers`);
    return manufacturers.data;
}

export async function getFamilies(manufacturer: string, organization: string) {
    const families = await axios.get(`${API_URL}/config/${organization}/families/${manufacturer}`);
    return families.data;
}

export async function getModels(family: string, organization: string) {
    const models = await axios.get(`${API_URL}/config/${organization}/models/${family}`);
    return models.data;
}
...
export async function updateManufacturerConfig(manufacturer: string, config: any, organization: string) {
    const newObj = await axios.post(`${API_URL}/config/${organization}/update-manufacturer-config`, {
        id: manufacturer,
        config
    });
    return newObj.data;
...
export async function updateFamilyConfig(family: string, config: any, organization: string) {
    const newObj = await axios.post(`${API_URL}/config/${organization}/update-family-config`, {
        id: family,
        config
    });
    return newObj.data;
...
export async function updateModelConfig(model: string, config: any, organization: string) {
    const newObj = await axios.post(`${API_URL}/config/${organization}/update-model-config`, {
        id: model,
        config
    });
    return newObj.data;
...
export async function getOrganizations() {
    const organizations = await axios.get(`${API_URL}/config/organizations`);
